        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-18 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <button
              ...
              className={`p-2.5 rounded-xl border text-xs font-semibold flex items-center gap-1.5 transition ${audioEnabled
                  ...
                  {shelfStock.map((item) => {
                    ...
                    return (
                      <tr key={item.id} className="hover:bg-slate-50/70 transition-colors">
                        ...
                        <td className="py-3.5">
                          <span className={`inline-flex items-center px-2 py-0.5 rounded-full text-xs font-semibold ${isLow
              ...
              <div className="space-y-3">
                {recentEvents.map((ev) => (
                  <div key={ev.id} className="p-3 rounded-xl bg-slate-50/80 border border-slate-100 flex items-start justify-between gap-3 text-xs">
                    ...
                    <span className={`w-2 h-2 rounded-full mt-1 shrink-0 ${ev.type === "alert" ? "bg-amber-500" : ev.type === "pick" ? "bg-indigo-500" : "bg-emerald-500"
                      }`} />
                  </div>
                ))}
              </div>
